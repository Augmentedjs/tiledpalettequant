import image from "../images/deus_ex_denton.png";

const BigForm = () => {
  return (
    <>
      <img id="source_img" src={image} alt="source image" />
      <table>
        <tr>
          <td>
            <label htmlFor="image_selector">Input image:</label>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="number" id="tile_width" min="1" max="32" step="1" value="8" />
          </td>
        </tr>
        <tr>
          <td>
            <label htmlFor="tile_height">Tile height</label>
          </td>
          <td>
            <input type="number" id="tile_height" min="1" max="32" step="1" value="8" />
          </td>
        </tr>
        <tr>
          <td>
            <label htmlFor="palette_num">Palettes:</label>
          </td>
          <td>
            <input type="number" id="palette_num" min="1" max="16" step="1" value="4" />
          </td>
        </tr>
        <tr>
          <td>
            <label htmlFor="colors_per_palette">Colors per palette:</label>
          </td>
          <td>
            <input type="number" id="colors_per_palette" min="2" max="256" step="1" value="16" />
          </td>
        </tr>
        <tr>
          <td>
            <label htmlFor="bits_per_channel">Bits per channel:</label>
          </td>
          <td>
            <input type="number" id="bits_per_channel" min="2" max="8" step="1" value="3" />
          </td>
        </tr>
        <tr>
          <td>
            <label htmlFor="fraction_of_pixels">Fraction of pixels:</label>
          </td>
          <td>
            <input
              type="number"
              id="fraction_of_pixels"
              min="0.01"
              max="10"
              step="any"
              value="0.1"
        ...
        <table>
          ...
          <tr>
            <td>
              <input
                type="radio"
                id="transparent_from_transparent"
                name="color_zero"
                value="transparent_from_transparent"
              />
              <label htmlFor="transparent_from_transparent">
          ...
          <tr>
            <td>
              <input
                type="radio"
                id="transparent_from_color"
                name="color_zero"
                value="transparent_from_color"
              />
      ...
      <fieldset>
        ...
        <table>
          ...
          <tr>
            <td>
              <label htmlFor="dither_weight">Dither weight:</label>
            </td>
            <td>
              <input type="number" id="dither_weight" min="0.01" max="1" step="any" value="0.5" />
            </td>
          </tr>
        </table>
      </fieldset>
        ...
        <table>
          ...
          <tr>
            <td>
              <input
                type="radio"
                id="dither_horizontal4"
                name="dither_pattern"
                value="dither_horizontal4"
              />
            ...
            <td>
              <input
                type="radio"
                id="dither_horizontal2"
                name="dither_pattern"
                value="dither_horizontal2"
              />
      ...
      <div>
        <button type="button" id="quantizeButton">
          Quantize
        </button>
